...
if __name__ == "__main__":
    ...
    while True:
        ...
        if option == "1":
            processing = input("If you want parallel processing enter p, else for serial enter s: ").strip()
            if processing == "p":
                num_cores = input("How many cores would you like to use? Enter a number from 1 to 15. Hit enter for default value (available cores minus one).")
