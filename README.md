...
We have made an effort to save output (transcriptions, AI corrections, analytics, etc) to RAM (ie data structures such as lists) before writing to file. This reduces bottlenecks while 
